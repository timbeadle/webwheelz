...
<CFQUERY name="wheellist" datasource="wheels">
	...
	<CFPARAM NAME="wireframe" default=#wfmodel#>
...
-->
<META HTTP-EQUIV="Refresh" CONTENT="1200; URL=http://PC-0001/webwheelz/">
...
<DIV class="nav">
<A HREF="../index.cfm" onMouseDown="imgActtoo('img1')" onMouseUp="imgInacttoo('img1')"> 
  <IMG name="img1" SRC="../images/mainmenu.gif" height="41" width="100" border="0"> 
</a>
<A HREF="selector.cfm" onMouseDown="imgActtoo('img2')" onMouseUp="imgInacttoo('img2')"> 
  <IMG name="img2" SRC="../images/selector.gif" height="41" width="100" border="0"> 
</a>
<A HREF="selector1.cfm" onMouseDown="imgActtoo('img3')" onMouseUp="imgInacttoo('img3')"> 
	<IMG name="img3" SRC="../images/makes.gif" height="41" width="100" border="0"> 
</a>
<CFOUTPUT>
<A HREF="selector1.cfm?make=#make#" onMouseDown="imgActtoo('img7')" onMouseUp="imgInacttoo('img7')">
  <img name="img7" src="../images/currentmake.gif" width="100" height="41" border="0"> 
</a>
</CFOUTPUT>
<A HREF="../search/search.cfm" onMouseDown="imgActtoo('img4')" onMouseUp="imgInacttoo('img4')"> 
  <IMG name="img4" src="../images/search.gif" width="100" height="41" border="0"> 
</a>
<A HREF="#" onMouseDown="imgActtoo('img5')" onMouseUp="imgInacttoo('img5')" onClick="MM_showHideLayers('document.layers[\'helptext\']','document.all[\'helptext\']','show')"> 
  <IMG name="img5" src="../images/help.gif" width="100" height="41" border="0"> 
</a>
<A HREF="#" onMouseDown="imgActtoo('img6')" onMouseUp="imgInacttoo('img6')" onClick="openWin('../bts/bts.htm#selector2');"> 
...
<CFIF #wfmodel# IS 1>
	...
	<DIV ID="controls" style="position: absolute; left: 420px; top: 480px; width: 200px"> 
		<A HREF="JavaScript:MM_showHideLayers('document.layers[\'front34\']','document.all[\'front34\']','hide','document.layers[\'rear34\']','document.all[\'rear34\']','show')">
			<IMG SRC="../images/rotateccw.gif" border="0">
		</a>
		<A HREF="JavaScript:MM_showHideLayers('document.layers[\'front34\']','document.all[\'front34\']','show','document.layers[\'rear34\']','document.all[\'rear34\']','hide')">
			<IMG SRC="../images/rotatecw.gif" border="0">
		</A> 
	</DIV>
</cfif>
</CFOUTPUT>
