...
<HTML>
<HEAD>
	<TITLE>CFML Source Code for selector1.cfm plus makes.inc</TITLE>
...
do you drive?
&LT/DIV&GT
&LTDIV ID="topline" style="position: absolute; left: 0px; top: 180px; z-index: 0"&GT
&LTIMG src="../images/line.gif" width="792" height="2"&GT
&LT/DIV&GT

&LTDIV ID="bottomline" style="position: absolute; left: 232px; top: 567px; z-index: 40"&GT
&LTIMG src="../images/line.gif" width="792" height="2"&GT
&LT/DIV&GT
...
&LT/DIV&GT
&LTCFOUTPUT&GT
&LTDIV ID="holderimg" style="position: absolute; left: 790px; top: 458px; width: 200px; height: 200px; z-index: 30"&GT
...
&LTDIV ID="helptext" style="text-align: left; background: white; position: absolute;	left: 620px;	top: 25px;	width: 300px; border: solid; padding: 10px;	visibility: hidden; z-index: 30;"&GT
